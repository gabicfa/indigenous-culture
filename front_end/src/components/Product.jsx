...
class Product extends Component {
    ...
    render() {
        const actions = [
            <FlatButton label="VEJA PRODUTOS" onClick={this.handleFilter}/>
          ];
        const action_pay = [
            ...
            <div style={styles.block} >
                ...
                <div>
                    ...
                    <Card>
                        ...
                        <CardText>
                            {this.props.info.tribe_description}
                            {this.props.info.tribe_extra_description}
                        </CardText>
                    </Card>
                    </Dialog>
                </div>
                    ...
                    <CardMedia expandable={true}>
                        <div style={{height:"200"}}>
                            <div className="row">
                                ...
                                <div className="col s12 m4 l7" style={{marginTop: -20}}><p>{this.props.info.tribe_description}</p><FlatButton label="CONHEÇA" onClick={this.handleOpen} /></div>  
                            </div>                          
                        </div>
                    </CardMedia>
